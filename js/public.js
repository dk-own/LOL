...
$.each(data,function(i,arr){
    if(arr.iParentId == 0){
        var a = $('<li class="menu_zhongli">'+
        '<a id=menu_'+arr.iSeqId+' href="" class="click">'+arr.sName+'</a>'+
        '<i class="menu-ico"></i>'+
    '</li>');
        $('.menu_zhong').append(a);
    }
...
$.each(data,function(i,arr){
    if(arr.iParentId == 46){
        ...
        <li>
            <a href="" class="submenu-link" parentid="menu_46">${arr.sName}</a>
        </li>
        `);
...
$.each(data,function(i,arr){
    if(arr.iParentId == 47){
        ...
        <li>
            <a href="" class="submenu-link" parentid="menu_47">${arr.sName}</a>
        </li>
        `);
...
$.each(data,function(i,arr){
    if(arr.iParentId == 48){
        ...
        <li>
            <a href="" class="submenu-link" parentid="menu_48">${arr.sName}</a>
        </li>
        `);
...
$.each(data,function(i,arr){
    if(arr.iParentId == 74){
        ...
        <li>
            <a href="" class="submenu-link" parentid="menu_74">${arr.sName}</a>
        </li>
        `);
...
$.each(data,function(i,arr){
    if(arr.iParentId == 49){
        ...
        <li>
            <a href="" class="submenu-link" parentid="menu_49">${arr.sName}</a>
        </li>
        `);
...
$.each(data,function(i,arr){
    if(arr.iParentId == 57){
        ...
        <li>
            <a href="" class="submenu-link" parentid="menu_57">${arr.sName}</a>
        </li>
        `);
